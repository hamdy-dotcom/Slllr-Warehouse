...
export async function GET(request: NextRequest) {
  ...
  const columns: Column[] = [
    ...
    { header: t("export.awaitingQty"), width: 16, sum: true, format: QTY },
    { header: t("export.awaitingValue"), width: 18, sum: true, format: MONEY },
    { header: t("export.warehouseQty"), width: 15, sum: true, format: QTY },
    { header: t("export.warehouseValue"), width: 17, sum: true, format: MONEY },
    { header: t("export.outQty"), width: 16, sum: true, format: QTY },
    { header: t("export.outValue"), width: 17, sum: true, format: MONEY },
  ...
  for (const po of rows) {
    posSheet.addRow([
      ...
      po.qty_approved,
      po.po_value,
      po.qty_awaiting_transfer,
      po.awaiting_transfer_value,
      po.qty_in_warehouse,
      po.in_warehouse_value,
      po.qty_out_for_delivery,
      po.out_for_delivery_value,
      po.qty_delivered,
      po.delivered_value,
      po.qty_cancelled,
      statusLabel(po),
